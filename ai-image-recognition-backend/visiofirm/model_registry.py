...
def _default_catalog() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"id": "yolov8m-seg", "name": "YOLOv8-medium-Seg", "task": "segmentation", "source": "ultralytics:yolov8m-seg.pt", "size": "71MB", "accuracy": "高", "speed": "中等"},
        {"id": "yolov8l-seg", "name": "YOLOv8-large-Seg", "task": "segmentation", "source": "ultralytics:yolov8l-seg.pt", "size": "151MB", "accuracy": "高", "speed": "慢速"},
        # 分类（可选，若后端支持从文件加载分类模型可加）
        {"id": "yolov8n-cls", "name": "YOLOv8-nano-Cls", "task": "classification", "source": "ultralytics:yolov8n-cls.pt", "size": "6MB", "accuracy": "通用", "speed": "极快"},
        {"id": "yolov8s-cls", "name": "YOLOv8-small-Cls", "task": "classification", "source": "ultralytics:yolov8s-cls.pt", "size": "22MB", "accuracy": "通用", "speed": "快速"},
        {"id": "yolov8m-cls", "name": "YOLOv8-medium-Cls", "task": "classification", "source": "ultralytics:yolov8m-cls.pt", "size": "52MB", "accuracy": "高", "speed": "中等"},
        {"id": "yolov8l-cls", "name": "YOLOv8-large-Cls", "task": "classification", "source": "ultralytics:yolov8l-cls.pt", "size": "87MB", "accuracy": "高", "speed": "慢速"},
        {"id": "yolov8x-cls", "name": "YOLOv8-xlarge-Cls", "task": "classification", "source": "ultralytics:yolov8x-cls.pt", "size": "136MB", "accuracy": "很高", "speed": "较慢"},
    ]
