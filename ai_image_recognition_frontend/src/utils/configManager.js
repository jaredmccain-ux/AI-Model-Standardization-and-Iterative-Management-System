...
const defaultConfig = {
  ...
  exportPath: '',
  augmentationMode: 'ai',
  augmentationProviderPreset: 'dashscope',
  augmentationApiStyle: 'dashscope_multimodal',
  augmentationApiKey: '',
  augmentationBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
  augmentationImageUrl: 'https://dashscope.aliyuncs.com/api/v1/services/aigc/multimodal-generation/generation',
  augmentationTextModel: 'qwen-turbo',
  augmentationImageModel: 'qwen-image-2.0',
  classicAugmentationOptions: ['brightness_up', 'flip_horizontal']
};
